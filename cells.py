...
class LSTMDecoderCell(ExtendedRNNCell):
    ...
    def build_model(self, input_shape):
        ...
        i = Activation('sigmoid')(z0)
        f = Activation('sigmoid')(z1)
        c = add([multiply([f, c_tm1]), multiply([i, Activation('sigmoid')(z2)])])
        o = Activation('tanh')(z3)
        h = multiply([o, Activation('sigmoid')(c)])
        y = Activation('sigmoid')(W2(h))
